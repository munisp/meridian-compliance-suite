// Command vasp-carf is the Meridian T10 VASP/CARF service: VASP trade and
// transfer ingest, cost-basis engine (FIFO + weighted-average), FMV snapshot
// cache, ring-fence calculation, per-asset gain/loss accounting ledger, OECD
// CARF XML message builder with correction loop, and reg-watch gate
// enforcement (carf.transmit_enabled / carf.gate.changed) with local gate
// file fallback. Dev-standalone (SPEC §1.3).
package main
